...
import NewReglement from "../../utilities/ajouterReglementF.jsx";
...
const Reglements = (Props) => {
  ...
  useEffect(() => {
    ...
    ipcRenderer.on("Reglements", () => {
      ...
      ipcRenderer.send("sendMeReglements", "fournisseur");
    });
    ipcRenderer.send("sendMeReglements", "fournisseur");
  ...
  return (
    <section className="Devis_section">
      ...
      <h2 className="section_title">
        <FontAwesomeIcon icon={faFileInvoice} /> Reglements Fournisseurs
      </h2>
